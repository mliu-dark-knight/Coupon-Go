package edu.illinois.cs465.walkingrewardapp.Maps;
...
import edu.illinois.cs465.walkingrewardapp.WalkingActivity;
...
public  class TouchableWrapper extends FrameLayout {
    ...
    public TouchableWrapper(Context context) {
        ...
        try {
            updateMapAfterUserInterection = (WalkingActivity) context;
